...
\begin{minipage}[t]{0.66\textwidth}
        ...
        \vspace{\topsep}
     %   \begin{tightemize}
     %   \item Concentration: Cybersecurity, Cryptography
     %   \end{tightemize}
        \sectionsep
        ...
        \location{September 2019 - Present | The George Washington University}
        ...
        \sectionsep
        \runsubsection{Research Experience for Undergraduates}
        \descript{| Scholarship}
